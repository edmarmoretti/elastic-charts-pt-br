...
function LegendComponent(props: LegendStateProps & LegendDispatchProps) {
  ...
  return (
    <div className={legendClasses} style={positionStyle} dir={isMostlyRTL ? 'rtl' : 'ltr'}>
      {config.customLegend ? (
        // if using a custom legend we ignore all the internal legend styles and just use a container
        // with the correct margins
        // the custom legend is responsible for all the layout and styling
        // we just pass the legend items and the actions to it
